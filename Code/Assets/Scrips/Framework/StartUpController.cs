...
public class StartUpController : MonoBehaviour {
	...
	IEnumerator LoadMainAndRoom() {
		...
		this.AsyncMain = Application.LoadLevelAsync ("Main");
		this.MainLoading = true;
		yield return this.AsyncMain;

		this.AsyncMainSceneGui = Application.LoadLevelAsync ("MainGui");
		this.MainSceneGuiLoading = true;
		yield return this.AsyncMainSceneGui;

		//加载房间
		this.AsyncRoom = Application.LoadLevelAsync (MtaGameStateManager.Instance.EntryState.LevelName);
