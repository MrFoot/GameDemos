...
namespace Soulgame.StateManagement
{
	...
	public abstract class StateManager<S, A> : StateManager where S : StateManager<S, A>.State {
		...
		public abstract class State
		{
			...
			public abstract void OnEnter(S previousState, object data);
			
			public abstract void OnExit(S nextState, object data);
			
			public abstract void OnAction(A gameAction, object data);
