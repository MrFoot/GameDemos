    ...
    public class HttpProc
    {
        ...
        private void httpPostProc()
        {
            ...
            try
            {
                ...
                m_httpData = client.UploadData(new Uri(m_myUrl), mPostData);
                //m_httpData = AESTools.AESNetDecrypt(m_httpData);

                //Debug.Log("result=" + result);

                //m_httpData = Encoding.UTF8.GetBytes(result);
                //m_httpData = result;
